#!/usr/bin/env python3
"""Governed synthetic-only Session 14a numerical integration review."""
...
START = "2a2ebe571aa85c0c850dc4139ebcd01350856dae"
TAG_TARGET = "f00690c05d8c1c6db308a65bd311c43f9a8ef2fa"
PROTOCOL = Path("docs/protocols/phase_14a_synthetic_numerical_integration_review.md")
OUT = Path("outputs/continuous_occlusion_numerics")
...
IMPLEMENTATION = (
    ...
    "scripts/session_14a_synthetic_numerics.py",
    "tests/test_session14a_numerics.py",
)
...
def publication_check() -> None:
    ...
    if any(qc[key] for key in ("empirical_states_read","models_loaded","targets_read","oracle_failures","reference_failures")):
    ...
    print("Session 14a publication check passed")
