"""Synthetic-only tests of the assembled Session 14R8 study path."""
...
spec=importlib.util.spec_from_file_location('r7',ROOT/'scripts/session_14r8_occlusion_study.py')
runner=importlib.util.module_from_spec(spec);spec.loader.exec_module(runner)


class Session14R8StudyTests(unittest.TestCase):
    ...
    def test_no_prohibited_routes_and_path_escape(self):
        source=(ROOT/'scripts/session_14r8_occlusion_study.py').read_text()
